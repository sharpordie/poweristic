...
function Set-DefaultSettings {
    ...
    if (Test-Path -Path $settings) {
        ...
        $document.SelectSingleNode('//*[@id="addons.unknownsources"]').'#text' = 'true'
        $document.SelectSingleNode('//*[@id="locale.country"]').default = 'false'
        $document.SelectSingleNode('//*[@id="locale.country"]').'#text' = 'Belgique'
        $document.SelectSingleNode('//*[@id="locale.language"]').default = 'false'
        $document.SelectSingleNode('//*[@id="locale.language"]').'#text' = 'resource.language.fr_fr'
        $document.SelectSingleNode('//*[@id="videoplayer.adjustrefreshrate"]').default = 'false'
        $document.SelectSingleNode('//*[@id="videoplayer.adjustrefreshrate"]').'#text' = '2'
        $document.SelectSingleNode('//*[@id="videoplayer.usedisplayasclock"]').default = 'false'
        $document.SelectSingleNode('//*[@id="videoplayer.usedisplayasclock"]').'#text' = 'true'
        $document.SelectSingleNode('//*[@id="services.webserver"]').default = 'false'
        $document.SelectSingleNode('//*[@id="services.webserver"]').'#text' = 'true'
        $document.SelectSingleNode('/settings/defaultvideosettings/centermixlevel').'#text' = '5'
        $document.SelectSingleNode('/settings/defaultvideosettings/scalingmethod').'#text' = '9' # Lanczos3
        $document.SelectSingleNode('/settings/defaultvideosettings/tonemapmethod').'#text' = '3' # Hable
